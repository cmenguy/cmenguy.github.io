...
If you read the [LoRA post](/llm/fine-tuning/2025/12/28/lora-deep-dive.html), you know the mechanics. Here's the application to code completion. We're using `peft` and `trl` to keep it concise, but the underlying math is the same.
